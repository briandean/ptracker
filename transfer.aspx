...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="id" DataSourceID="ObjectDataSource1"
        ...
        <EditItemTemplate>
            ...
            Transfer Resource:<asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="ObjectDataSource5"
                DataTextField="name" DataValueField="name" SelectedValue='<%# Bind("visiting") %>'>
            </asp:DropDownList><br />
            Office:
            <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="ObjectDataSource2"
                DataTextField="office" DataValueField="id" SelectedValue='<%# Bind("office") %>'>
            ...
            Appointment Time:<asp:TextBox ID="timeTextBox" runat="server" Text='<%# Bind("time") %>'></asp:TextBox><br />
