...
<h1>Status of patients by doctor</h1>
    Office:
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete"
        InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetWaitingandInRoomVisiting"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList3" Name="visiting" PropertyName="SelectedValue"
                Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="status" Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataAllDoctors"
        TypeName="ptrackerTableAdapters.doctorsTableAdapter">
        <DeleteParameters>
            <asp:Parameter Name="Original_id" Type="Int32" />
        </DeleteParameters>
    </asp:ObjectDataSource>
    <b><asp:UpdatePanel id="UpdatePanel2" runat="server" UpdateMode="Conditional"><contenttemplate>
<asp:GridView id="GridView1" runat="server" DataSourceID="ObjectDataSource1" OnRowDataBound="HighlightedInRoom_RowDataBound" Font-Bold="False" EmptyDataText="No Patients Waiting" DataKeyNames="id" AutoGenerateColumns="False" AllowSorting="True" __designer:wfdid="w71"><Columns>
